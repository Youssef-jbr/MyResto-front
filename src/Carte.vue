			...
			<div class="row tm-gallery">
				...
				<div id="tm-gallery-page-pizza" class="tm-gallery-page">
					<article class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
						<figure>
							<img src="./assets/01.jpg" alt="Image" class="img-fluid tm-gallery-img" />
							<figcaption>
					...
					<article class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
						<figure>
							<img src="./assets/02.jpg" alt="Image" class="img-fluid tm-gallery-img" />
							<figcaption>
					...
					<article class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
						<figure>
							<img src="./assets/03.jpg" alt="Image" class="img-fluid tm-gallery-img" />
							<figcaption>
					...
					<article class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
						<figure>
							<img src="./assets/04.jpg" alt="Image" class="img-fluid tm-gallery-img" />
							<figcaption>
								<h4 class="tm-gallery-title">Aliquam sagittis</h4>
								<p class="tm-gallery-description">Nam in suscipit nisi, sit amet consectetur metus. Ut sit amet tellus accumsan</p>
					...
					<article class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
						<figure>
							<img src="./assets/05.jpg" alt="Image" class="img-fluid tm-gallery-img" />
							<figcaption>
					...
					<article class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
						<figure>
							<img src="./assets/06.jpg" alt="Image" class="img-fluid tm-gallery-img" />
							<figcaption>
					...
					<article class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
						<figure>
							<img src="./assets/07.jpg" alt="Image" class="img-fluid tm-gallery-img" />
							<figcaption>
					...
					<article class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
						<figure>
							<img src="./assets/08.jpg" alt="Image" class="img-fluid tm-gallery-img" />
							<figcaption>
