<template>
  ...
  <div class="d-flex w-50 mx-auto  justify-content-center align-items-center">
      ...
      <img src="./assets/visa.png" alt=".." class="img-fluid w-50"/>
      <label for="huey">Visa</label>
       <input type="radio" id="huey" name="drone" value="huey" style="font-size:30px"
         checked>
     </div>

   <div class="d-flex flex-column justify-content-center align-items-center ml-5 ">
   <img src="./assets/masterclass.png" alt=".." class="img-fluid w-50"/>
  <label for="dewey">Master Card</label>
  <input type="radio" id="dewey" name="drone" value="dewey" style="font-size:30px">
  </div>

   <div class="d-flex flex-column justify-content-center align-items-center ml-5 ">
   <img src="./assets/paypal.png" alt=".." class="img-fluid w-50"/>
   ...
   <h4 class="text-center mt-5">Credit card</h4>
    <form method="post" action="#"  class="w-50 mx-auto mt-4 rounded shadow p-4 mb-5">
        <div class="form-row  d-flex justify-content-center align-items-center ">
            <div class="col-7 ">
                Prenom
                <input name="nom" type="text" class="form-control" placeholder="prenom" requiredee>
            </div>
             <div class="col-5 ">
                Nom 
                <input name="nom" type="text" class="form-control" placeholder="Nom" requiredee>
            </div>
       ...
       <select name="pets" id="pet-select" class="form-control">
        ...
        <div class="col">
               Année d'expiration
            <input name="annee" type="number" class="form-control" placeholder="annee d'expriration" requiredee>
         </div>
    </div>
     <div class="form-row  d-flex justify-content-center align-items-center ">
            <div class="col">
               Adresse
                <input name="adresse" type="text" class="form-control" placeholder="Adresse" requiredee>
            </div>
            </div>
        ...
        <div class="form-row ">
            <div class="col mt-3">
                <input type="submit" value="Confirmer" name="submit" class="btn btn-outline-success rounded" />
            </div>
